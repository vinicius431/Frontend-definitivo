...
app.post("/gerar-conteudo", async (req, res) => {
  ...
  try {
    const resposta = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          {
            role: "user",
            content: `Crie 10 títulos (headlines) e 10 descrições criativas para um post sobre: ${tema}. Formato de resposta: "Headlines:\n1. ...\n2. ...\n\nDescrições:\n1. ...\n2. ..."`,
          },
        ],
        temperature: 0.7,
      }),
    ...
    console.log("RESPOSTA IA BRUTA >>>", respostaIA);
